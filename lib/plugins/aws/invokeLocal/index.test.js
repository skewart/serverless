...
describe('AwsInvokeLocal', () => {
  ...
  describe('#loadEnvVars()', () => {
    ...
    it('should not load null environment variables', () => awsInvokeLocal
      .loadEnvVars().then(() => {
        expect(process.env.nullProviderVar).to.be.undefined;
        expect(process.env.nullFunctionVar).to.be.undefined;
      }));
  });
